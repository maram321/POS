...
import { getSalesBills, deleteSaleBill } from '../services/salesBillService';
import "./accounts.css"


class SalesAccounts extends Component {
    state = {
        bills: [],
        selectedBill: null,
        user: {},
    ...
    async componentDidMount() {
        const {data : bills} = await getSalesBills();
        this.setState({ bills });
